...
bad antenna. did not use coax, but SMA...
briefly talk about failed amplifier (not LNA!)

\url{http://marcusjenkins.com/amateur-radio-2/a-signal-amplifier-module-for-hf/}


talk about touching/not touching reader (antenna)

talk about real usrp signal vs already touching (tag)

example traces in appendix
